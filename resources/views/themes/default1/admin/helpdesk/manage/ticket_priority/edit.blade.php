  ...
  <form action="{!!URL::route('priority.edit1')!!}" method="post" role="form">
    ...
    <div class="box box-primary">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                  ...
                  <input type="radio" name="status" value="1" {{$tk_priority->status == '1' ? 'checked' :
                  ''}}>{{Lang::get('lang.active')}}
                  <input type="radio" name="status" value="0" {{$tk_priority->status == '0' ? 'checked' :
              ...
              <div class="col-md-3">
                <div class="form-group {{ $errors->has('ispublic') ? 'has-error' : '' }}">
                  ...
                  <input type="radio" name="ispublic" value="0" {{$tk_priority->ispublic == '0' ? 'checked' :
      ...
      <div class="box-footer">
        <div class="form-group">
          <input type="checkbox" name="default_priority" @if($tk_priority->is_default == $tk_priority->priority_id)
          checked disabled @endif> {{ Lang::get('lang.make-default-priority')}}
        </div>
        <div class="form-group">
        </div>
