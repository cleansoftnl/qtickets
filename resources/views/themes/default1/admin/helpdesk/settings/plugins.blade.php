...
@section('content')
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <button type="button" class="btn btn-primary pull-right" id="Edit_Ticket" data-toggle="modal" data-target="#Edit">
        <b>{!! Lang::get('lang.add_plugin') !!}</b></button>
    ...
    <div class="box-body">
      <div class="alert alert-info alert-dismissable">
        ...
        <a href="http://www.faveohelpdesk.com/plugins/"
           target="_blank">{!!Lang::get('lang.click-here')!!}</a>&nbsp;{!!Lang::get('lang.plugin-info-pro')!!}
      </div>
      @if (count($errors) > 0)
