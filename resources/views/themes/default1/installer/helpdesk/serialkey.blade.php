      ...
      <table ng-controller="AutotabController">
        ...
        <tr>
          ...
          <td style="">
            ...
            <input type="text" name="order_no" id="order_no" style="margin-left:180px;width:274px;border-width','1px'"
                   value="" required>
            <br/><br/>
          </td>
        </tr>
          ...
          <td ng-repeat="productKey in productKeys" style="margin-left: 150px;">
            ...
            <div class="container">
              <input type="text" name="first" id="productKey1" ng-model="productKey.set1" maxlength="4" size="4"
                     style="padding: 3px; margin-left: 180px; width: 50px; text-transform:uppercase;border-width','1px'"
                     onkeydown="myFunction(event, this.id);" required>&nbsp;-
              <input type="text" name="second" id="productKey2" ng-model="productKey.set2" maxlength="4" size="4"
                     style="padding: 3px; margin-left: 3px; width: 50px; text-transform:uppercase;border-width','1px'"
                     onkeydown="myFunction(event, this.id)" required>&nbsp;-
              <input type="text" name="third" id="productKey3" ng-model="productKey.set3" maxlength="4" size="4"
                     style="padding: 3px; margin-left: 3px; width: 50px; text-transform:uppercase;border-width','1px'"
                     onkeydown="myFunction(event, this.id)">&nbsp;-
