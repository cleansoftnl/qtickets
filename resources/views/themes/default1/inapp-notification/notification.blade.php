...
<li class="dropdown notifications-menu">
  ...
  <ul class="dropdown-menu"
      style="background: #fff;border: 1px solid rgba(100, 100, 100, .4);border-radius: 0 0 2px 2px;box-shadow: 0 3px 8px rgba(0, 0, 0, .25);color: #1d2129;overflow: visible;position: absolute !important;width: 430px !important;z-index: -1;">
    <li class="header">
      <div class="cool" style="width: 50%;"><b>Notifications</b></div>
    </li>
    <li>
      ...
      <div>
        <ul class="list-group"
            style="outline: none;overflow-x: hidden;overflow-y: auto; height: 425px;margin-bottom: 0px;"
            when-scrolled="loadApi()">
          <li class="row list-group-item" id=seen@{{$index}}  ng-repeat="noti in notifications.data
          ">
          <a href="javascript:void(0)" class="link" alt=""
             style="color: #1d2129;display: block;padding: 6px 30px 5px 12px;position: relative;"
             ng-click="newTab(noti.url,noti.id)">
            <div class="col-sm-12">
              <div class="col-sm-2" style="padding-right: 0px;padding-left: 0px;">
                <img alt="" class="notiimg" ng-src="@{{noti.requester.profile_pic}}"
                     style="display: block;height: 44px;margin-right: 12px;width: 44px;">
              </div>
              <div class="col-sm-10" style="padding-right: 0px;padding-left: 0px;">

                <div class="cont"
                     style="display: flex;flex-direction: column;justify-content: center;margin-top: -1px;min-height: 50px;word-wrap: break-word;overflow: hidden;">
                                        <span><b>@{{noti.user}}</b>
